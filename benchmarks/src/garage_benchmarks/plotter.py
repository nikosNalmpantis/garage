...
env_ids = [
    'InvertedDoublePendulum-v2', 'InvertedPendulum-v2', 'HalfCheetah-v2',
    'Hopper-v2', 'Swimmer-v2'
]

plot_dir = '/home/resl/iris/plots/Sept08_tf'  # make sure this dir exists, the script doesn't create it
...
for env_id in env_ids:
    ...
    dir = [
        ...
        + env_id + '_', 
        # '/home/resl/iris/garage/data/local/benchmarks/td3_benchmarks_1M/td3-garage-pytorch_'
        # + env_id + '_', 
        '/home/resl/iris/spinningup/spinup/outputs/td3-spinup-pytorch_' + str(env_id.lower())  + '/td3-spinup-pytorch_' + str(env_id.lower()),
    ]
    labels = ['td3-garage-tf', 'td3-openai-baselines']
    colors = ['C2', 'C1']
